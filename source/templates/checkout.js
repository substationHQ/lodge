...
/*
  <form id="braintree-token-form" class="scale-down">
    <div id="checkout-customer">
      ...
      <div class="input-wrapper"><input type="email" class="form-control" id="email" placeholder="you@youremail.com"></div>
    </div>
